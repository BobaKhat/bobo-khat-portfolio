      ...
      <div className="relative z-[1] flex flex-col overflow-hidden rounded-3xl bg-module p-5 shadow-[var(--shadow-raised)] transition-transform duration-300 group-hover:-translate-y-1 sm:p-6">
        <div className="flex items-start gap-3 sm:gap-4">
          ...
          {/* Tag, with the arrow button below it. min-w-0 (not shrink-0) so on
              ...
              the card and bleeding out the side. Hidden below 1200px: on
              mobile (full-width single column) and in the tablet range
              (md–1199) the tag column squeezes the left column, wrapping the
              subtitle to 3 lines and making cards mismatched in height. */}
          <div className="ml-auto flex min-w-0 flex-col items-end gap-3">
            {tag && (
              <p className="text-right t-eyebrow text-text-secondary max-[1199px]:hidden">
                {tag}
              </p>
            )}
            <div
