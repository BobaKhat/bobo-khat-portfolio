...
export default function CaseStudyLayout({
  ...
  return (
    <main className="mx-auto w-full max-w-[1000px] flex-1 px-5 pt-20 sm:px-8 sm:pt-[84px]">
      ...
      {/* Hero */}
      {heroVideo ? (
        <div className="mb-12 flex max-h-[720px] w-full items-center justify-center overflow-hidden rounded-2xl bg-module p-4">
        ...
        <div className="mb-12 aspect-[16/9] w-full overflow-hidden rounded-2xl bg-module">
          {heroImage ? (
