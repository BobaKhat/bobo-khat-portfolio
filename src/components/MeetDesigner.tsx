/*
  ...
  divider lines up with the other cards; the bio sits left, portrait to the right.
*/
export default function MeetDesigner() {
  return (
    <div className="relative flex flex-col overflow-hidden rounded-3xl bg-module p-5 shadow-[var(--shadow-raised)] sm:p-6">
