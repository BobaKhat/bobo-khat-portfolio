...
export default function DriftPage() {
  return (
    ...
    >
      ...
      <p>
        Drift maps a music library spatially. Every song is plotted on a 2D
      ...
      <p>
        The decoration became identity. Every song in Drift has a visual
      ...
      <p>
        ...
        only exist because Drift treats music as space, and they had to
